...
@property (nonatomic, nullable, strong) NSNumber *felt;
@property (nonatomic, nullable, strong) NSNumber *cdi;
@property (nonatomic, nullable, strong) NSNumber *mmi;
...
@property (nonatomic, nullable, strong) NSNumber *dmin;
@property (nonatomic, assign)           double rms;
@property (nonatomic, nullable, strong) NSNumber *gap;
